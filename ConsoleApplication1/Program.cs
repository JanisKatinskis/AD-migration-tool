...
namespace ConsoleApplication1
{
    class Program
    {
        ...
        public static void QueryGroups() // Queries Win32_Group and exports to XML
        {
        ...
        public static void QueryUsers() // Queries Win32_UserAccount and exports to XML
        {
        ...
        {
            PrincipalContext AD = new PrincipalContext(ContextType.Domain, "TELEKOM");
        ...
        public static void GroupsMembers()
        {
            PrincipalContext AD = new PrincipalContext(ContextType.Domain);
